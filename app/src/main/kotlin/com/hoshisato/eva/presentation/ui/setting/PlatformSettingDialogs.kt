...
import com.hoshisato.eva.presentation.common.TokenInputField
import com.hoshisato.eva.util.generateOpenAIModelList
import com.hoshisato.eva.util.getPlatformAPILabelResources
import com.hoshisato.eva.util.getPlatformHelpLinkResources
import com.hoshisato.eva.util.isValidUrl
                    ...
                    onValueChange = { t ->
                        ...
                        converted?.let {
                            sliderTemperature = when (apiType) {
                                ...
                                ApiType.OLLAMA -> it.coerceIn(0F, 2F)
